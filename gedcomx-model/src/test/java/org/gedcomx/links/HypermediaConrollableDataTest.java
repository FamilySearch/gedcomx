...
public class HypermediaConrollableDataTest {
  ...
  private void assertLink(CustomData data) {
    ...
    assertEquals("href1", data.getLink("rel1").getHref().toString());
    assertEquals("template1", data.getLinks("rel1").get(1).getTemplate());
  ...
  private CustomData createData() {
    ...
    data.addLink("rel1", URI.create("href1"));
    data.addTemplatedLink("rel1", "template1");
