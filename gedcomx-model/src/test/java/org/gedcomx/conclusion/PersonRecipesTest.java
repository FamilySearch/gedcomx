...
public class PersonRecipesTest extends RecipeTest {
  ...
  static Person create() {
    ...
    name.getNameForms().get(0).getParts().get(0).getQualifiers().add(new ResourceReference(NamePartQualifierType.PrimaryGiven.toQNameURI()));
    name.getNameForms().get(0).getParts().add(new NamePart());
    ...
    name.getNameForms().get(0).getParts().get(1).getQualifiers().add(new ResourceReference(NamePartQualifierType.SecondaryGiven.toQNameURI()));
    name.getNameForms().get(0).getParts().add(new NamePart());
    ...
    name.getNameForms().get(1).getParts().get(0).getQualifiers().add(new ResourceReference(NamePartQualifierType.PrimaryGiven.toQNameURI()));
    name.getNameForms().get(1).getParts().add(new NamePart());
    ...
    name.getNameForms().get(1).getParts().get(1).getQualifiers().add(new ResourceReference(NamePartQualifierType.SecondaryGiven.toQNameURI()));
    name.getNameForms().get(1).getParts().add(new NamePart());
