...
roles | The roles of the persons in the event. | gxc:role | Ordered list of [`gxc:EventRole`](#conclusion-event-role)
sources | The list of references to the evidence of the event. | gxc:source | Ordered list of [`gxc:SourceReference`](#source-reference)
