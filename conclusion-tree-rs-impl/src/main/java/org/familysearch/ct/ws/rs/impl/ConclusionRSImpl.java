 ...
 * @author Randy Bliss
 */
public class ConclusionRSImpl implements org.familysearch.ct.ws.rs.binding.ConclusionRSBinding {
     ...
     * @return The response.
     */
    public Response addConclusion( String personId ) {
     ...
     */
    public Response getConclusions( final String personId, Request request) {
      return Response.ok().build();
    }
    ...
    public Person getConclusion( String personId, String conclusionId) {
     ...
     * @return The response.
     */
    public Response editConclusion( String personId, String conclusionId) {
      return Response.ok().build();
    }
