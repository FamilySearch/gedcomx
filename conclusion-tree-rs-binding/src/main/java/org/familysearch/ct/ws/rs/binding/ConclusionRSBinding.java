...
public interface ConclusionRSBinding {
  ...
  Response addConclusion(@PathParam("personId") String personId);
  ...
  Response getConclusions(@PathParam("personId") String personId, @Context Request request);
  ...
  @Path("{conclusionId}")
  @Produces( { MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
  Person getConclusion(@PathParam("personId") String personId, @PathParam("conclusionId") String conclusionId);
  ...
  @Path("{conclusionId}")
  @Consumes( { MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
  Response editConclusion(@PathParam("personId") String personId, @PathParam("conclusionId") String conclusionId);
